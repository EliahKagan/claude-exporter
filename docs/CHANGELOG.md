...
- SVG and CSS artifacts are filed and fenced the way they always were when they arrived by the older route: `.svg` and `.css` rather than `.txt`, and fenced as code in the chat file rather than pasted into it raw.
